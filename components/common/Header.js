...
import { firstLetter } from "../utils/data";
import { companyName } from "../utils/data";
    ...
    <>
      <header>
        <div className='container'>
          <div className='logo'>
            <Link href='/'>
              <TitleLogo title={companyName} caption={firstLetter} className='logomin' />
            </Link>
          </div>
          <nav className={open ? "openMenu" : "closeMenu"} onClick={() => setOpen(null)}>
            ...
            <Link href='' className={activeLink == "/agency" ? "activeLink" : "none"}>
              Agency
            </Link>
